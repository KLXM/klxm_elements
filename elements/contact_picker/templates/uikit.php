...
$result = \FriendsOfREDAXO\Builder\ListRenderer::fetchPicked($picks, $elementData);
...
echo $wrapper->parse('klxm_elements/wrapper.php');
...
echo $wrapperClose->parse('klxm_elements/wrapper.php');
